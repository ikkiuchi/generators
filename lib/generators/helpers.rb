...
module Generators
  module Helpers
    ...
    def write type, content, to:
      tip = "# *** Generated by Zero [ please make sure that you have checked this file ] ***\n\n"
      puts ['    ', type.to_s.rjust(10).green, ' ',  File.exist?(to) ? 'OVERRIDE '.red : 'generated ', "#{to}"].join

      dir = File.dirname(to)
      FileUtils.mkdir_p(dir) unless File.directory?(dir)
      File.open(to, 'w') { |file| file.write tip + content }
    end
  end
end
